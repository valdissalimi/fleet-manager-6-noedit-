  ...
  <div class="col-md-12">
    ...
    <div class="card card-info">
      <div class="card-header">
        ...
        &nbsp;
        @can('Mechanics add')<a href="{{ route('mechanic.create')}}" class="btn btn-success">@lang('fleet.create_mechanic')</a>@endcan
        ...
        <table class="table" id="data_table">
          ...
          <tfoot>
            <tr>
              <th>
              @if($data->count() > 0)
              @can('Mechanics delete')<button class="btn btn-danger" id="bulk_delete" data-toggle="modal" data-target="#bulkModal" disabled>@lang('fleet.delete')</button>@endcan
              @endif
              </th>
              <th>@lang('fleet.name')</th>
              <th>@lang('fleet.email')</th>
