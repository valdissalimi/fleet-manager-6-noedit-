  ...
  <div class="col-md-12">
    ...
    <div class="card card-info">
      <div class="card-header">
        ...
        &nbsp; @can('Customer add')<a href="{{route("customers.create")}}" class="btn btn-success">@lang('fleet.add_new')</a>@endcan
        ...
        <table class="table" id="data_table" style="padding-bottom: 25px">
          ...
          <tfoot>
            <tr>
              <th>
                @if($data->count() > 0)
                @can('Customer delete')<button class="btn btn-danger" id="bulk_delete" data-toggle="modal" data-target="#bulkModal" disabled>@lang('fleet.delete')</button>@endcan
                @endif
              </th>
              <th>@lang('fleet.name')</th>
              <th>@lang('fleet.email')</th>
