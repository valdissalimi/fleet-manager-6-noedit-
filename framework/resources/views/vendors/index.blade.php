  ...
  <div class="col-md-12">
    ...
    <div class="card card-info">
      <div class="card-header">
        ...
        @lang('fleet.vendors')
        &nbsp;
        @can('Vendors add')<a href="{{ route('vendors.create')}}" class="btn btn-success">@lang('fleet.create_vendor')</a>@endcan
        ...
        <table class="table" id="data_table">
          ...
          <tfoot>
            <tr>
              <th>
              @if($data->count() > 0)
              @can('Vendors delete')<button class="btn btn-danger" id="bulk_delete" data-toggle="modal" data-target="#bulkModal" disabled>@lang('fleet.delete')</button>@endcan
              @endif
              </th>
              <th>@lang('fleet.picture')</th>
              <th>@lang('fleet.vendor')</th>
