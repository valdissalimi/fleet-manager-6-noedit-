  ...
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        ...
        @lang('fleet.notes')
        &nbsp;
        @can('Notes add')<a href="{{ route('notes.create')}}" class="btn btn-success">@lang('fleet.create_note')</a></h3>@endcan
      </div>
        ...
        <table class="table" id="data_table">
          ...
          <tfoot>
            <tr>
              <th>
                @if($data->count() > 0)
                @can('Notes delete')<button class="btn btn-danger" id="bulk_delete" data-toggle="modal" data-target="#bulkModal" disabled>@lang('fleet.delete')</button>@endcan
                @endif
              </th>
              <th>@lang('fleet.vehicle')</th>
              <th></th>
