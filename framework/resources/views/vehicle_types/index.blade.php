    ...
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title">@lang('fleet.vehicle_types') &nbsp;
          @can('VehicleType add')<a href="{{ route('vehicle-types.create')}}" class="btn btn-success">@lang('fleet.addNew')</a></h3>@endcan
      </div>
        ...
        <table class="table" id="data_table">
          ...
          <tfoot>
            <tr>
              <th>
                @if($data->count() > 0)
                @can('VehicleType delete')<button class="btn btn-danger" id="bulk_delete" data-toggle="modal" data-target="#bulkModal" disabled>@lang('fleet.delete')</button>@endcan
                @endif
              </th>
              <th>#</th>
              <th>@lang('fleet.icon_img')</th>
