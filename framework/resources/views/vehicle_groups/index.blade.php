  ...
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        ...
        &nbsp;
        @can('VehicleGroup add')<a href="{{ route('vehicle_group.create')}}" class="btn btn-success">@lang('fleet.createGroup')</a>@endcan</h3>
      </div>
          ...
          <tfoot>
            <tr>
              <th>
                ...
                @can('VehicleGroup delete')<button class="btn btn-danger" id="bulk_delete" data-toggle="modal" data-target="#bulkModal" disabled>@lang('fleet.delete')</button>@endcan
                @endif
              </th>
              <th>@lang('fleet.groupName')</th>
              <th>@lang('fleet.description')</th>
