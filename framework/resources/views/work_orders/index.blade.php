  ...
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        ...
        &nbsp;
        @can('WorkOrders add')<a href="{{ route('work_order.create')}}" class="btn btn-success">@lang('fleet.create_workorder')</a>@endcan</h3>
      </div>
        ...
        <table class="table" id="data_table">
          ...
          <tfoot>
            <tr>
              <th>
                @if($data->count() > 0)
                @can('WorkOrders delete')<button class="btn btn-danger" id="bulk_delete" data-toggle="modal" data-target="#bulkModal" disabled>@lang('fleet.delete')</button>@endcan
                @endif
              </th>
              <th>@lang('fleet.vehicle')</th>
              <th></th>
