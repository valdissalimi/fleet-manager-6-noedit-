  ...
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        ...
        &nbsp;
        @can('VehicleInspection add')<a href="{{ url('admin/vehicle-reviews-create')}}" class="btn btn-success">@lang('fleet.add_vehicle_inspection')</a>@endcan</h3>
      </div>
        ...
        <table class="table" id="data_table" style="padding-bottom: 25px">
          ...
          <tfoot>
            <tr>
              <th>
                @if($reviews->count() > 0)
                @can('VehicleInspection delete')<button class="btn btn-danger" id="bulk_delete" data-toggle="modal" data-target="#bulkModal" disabled>@lang('fleet.delete')</button>@endcan
                @endif
              </th>
              <th>@lang('fleet.vehicle')</th>
              <th>@lang('fleet.review_by')</th>
