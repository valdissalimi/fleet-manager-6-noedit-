    ...
    <div class="card-body login-card-body">
      ...
      <form class="form-horizontal" role="form" method="POST" action="{{ route('login') }}">
        ...
        <div class="form-group has-feedback">
          ...
          <input type="password" class="form-control" placeholder="@lang('passwords.password')" id="password" name="password" required>
        ...
        <div class="row">
          <div class="col-8">
            <div class="checkbox icheck">
              <label>
                <input type="checkbox" name="remember" {{ old('remember') ? 'checked' : '' }}>@lang('passwords.remember') 
                {{-- Remember Me --}}
              </label>
            </div>
          </div>
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" class="btn btn-primary btn-block btn-flat">@lang('passwords.sign_in') 
              {{-- Sign In --}}
            </button>
          </div>
          <!-- /.col -->
