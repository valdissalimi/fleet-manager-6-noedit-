  ...
  <div class="col-md-12">
    <div class="card card-info">
      <div class="card-header">
        ...
        &nbsp;
        @can('ServiceReminders add')<a href="{{ route('service-reminder.create')}}" class="btn btn-success" style="margin-bottom: 5px">@lang('fleet.add_service_reminder')</a>@endcan &nbsp;
        ...
        <table class="table" id="data_table">
          ...
          <tfoot>
            <tr>
              <th>
                @if($service_reminder->count() > 0)
                @can('ServiceReminders delete')<button class="btn btn-danger" id="bulk_delete" data-toggle="modal" data-target="#bulkModal" disabled>@lang('fleet.delete')</button>@endcan
                @endif
              </th>
              <th></th>
              <th>@lang('fleet.vehicle')</th>
