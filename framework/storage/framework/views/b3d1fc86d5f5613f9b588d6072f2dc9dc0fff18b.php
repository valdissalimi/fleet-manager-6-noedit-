    ...
    <div class="card card-info">
      <div class="card-header">
        <h3 class="card-title"><?php echo app('translator')->get('menu.drivers'); ?> &nbsp;
          <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Drivers add')): ?> <a href="<?php echo e(route("drivers.create")); ?>" class="btn btn-success"> <?php echo app('translator')->get('fleet.addDriver'); ?> </a> <?php endif; ?>
          <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Drivers import')): ?><button data-toggle="modal" data-target="#import" class="btn btn-warning"><?php echo app('translator')->get('fleet.import'); ?></button><?php endif; ?>
        </h3>
      </div>
        ...
        <table class="table" id="data_table" style="padding-bottom: 15px">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><?php if($row->vehicle_id != null): ?> <?php echo e($row->driver_vehicle->vehicle->maker->make); ?>-<?php echo e($row->driver_vehicle->vehicle->vehiclemodel->model); ?>-<?php echo e($row->driver_vehicle->vehicle->license_plate); ?> <?php endif; ?></td>
          ...
          <tfoot>
            <tr>
              <th>
                <?php if($data->count() > 0): ?>
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Drivers delete')): ?><button class="btn btn-danger" id="bulk_delete" data-toggle="modal" data-target="#bulkModal" disabled><?php echo app('translator')->get('fleet.delete'); ?></button><?php endif; ?>
                <?php endif; ?>
              </th>
              <th>#</th>
              <th><?php echo app('translator')->get('fleet.driverImage'); ?></th>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fleet-manager-6(noedit)\framework\resources\views/drivers/index.blade.php ENDPATH**/ ?>