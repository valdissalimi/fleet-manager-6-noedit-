    ...
    <div class="card-body login-card-body">
      ...
      <form class="form-horizontal" role="form" method="POST" action="<?php echo e(route('login')); ?>">
        ...
        <div class="form-group has-feedback">
          ...
          <input type="email" class="form-control" placeholder="<?php echo app('translator')->get('passwords.email'); ?>" name="email" value="<?php echo e(old('email')); ?>" id="email" autofocus required>
        ...
        <div class="form-group has-feedback">
          ...
          <input type="password" class="form-control" placeholder="<?php echo app('translator')->get('passwords.password'); ?>" id="password" name="password" required>
        ...
        <div class="row">
          <div class="col-8">
            <div class="checkbox icheck">
              <label>
                <input type="checkbox" name="remember" <?php echo e(old('remember') ? 'checked' : ''); ?>><?php echo app('translator')->get('passwords.remember'); ?> 
          ...
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" class="btn btn-primary btn-block btn-flat"><?php echo app('translator')->get('passwords.sign_in'); ?> 
...
</html><?php /**PATH C:\xampp\htdocs\fleet-manager-6(noedit)\framework\resources\views/auth/login.blade.php ENDPATH**/ ?>