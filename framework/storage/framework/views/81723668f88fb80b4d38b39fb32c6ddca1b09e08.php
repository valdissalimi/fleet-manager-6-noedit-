								...
								<div class="row">
									<div class="form-group col-md-3">
										...
										<div class="input-group mb-3">
											...
											<?php echo Form::number('name['.$type.'_base_fare]',Hyvikk::fare($type.'_base_fare'),['class'=>"form-control",'required','min'=>0,'step'=>'0.01']); ?>
									...
									<div class="form-group col-md-3">
										...
										<div class="input-group mb-3">
											...
											<?php echo Form::number('name['.$type.'_base_time]',Hyvikk::fare($type.'_base_time'),['class'=>"form-control",'required','min'=>0,'step'=>'0.01']); ?>
									...
									<div class="form-group col-md-3">
										...
										<div class="input-group mb-3">
											<div class="input-group-prepend">
											<span class="input-group-text"><?php echo e(Hyvikk::get('currency')); ?></span></div>
											<?php echo Form::number('name['.$type.'_std_fare]',Hyvikk::fare($type.'_std_fare'),['class'=>"form-control",'required','min'=>0,'step'=>'0.01']); ?>
									...
									<div class="form-group col-md-3">
										...
										<div class="input-group mb-3">
											<div class="input-group-prepend">
											<span class="input-group-text"><?php echo e(Hyvikk::get('currency')); ?></span></div>
											<?php echo Form::number('name['.$type.'_weekend_base_fare]',Hyvikk::fare($type.'_weekend_base_fare'),['class'=>"form-control",'required','min'=>0,'step'=>'0.01']); ?>
									...
									<div class="form-group col-md-3">
										...
										<div class="input-group mb-3">
											...
											<?php echo Form::number('name['.$type.'_weekend_wait_time]',Hyvikk::fare($type.'_weekend_wait_time'),['class'=>"form-control",'required','min'=>0,'step'=>'0.01']); ?>
									...
									<div class="form-group col-md-3">
										...
										<div class="input-group mb-3">
											<div class="input-group-prepend">
											<span class="input-group-text"><?php echo e(Hyvikk::get('currency')); ?></span></div>
											<?php echo Form::number('name['.$type.'_weekend_std_fare]',Hyvikk::fare($type.'_weekend_std_fare'),['class'=>"form-control",'required','min'=>0,'step'=>'0.01']); ?>
									...
									<div class="form-group col-md-3">
										...
										<div class="input-group mb-3">
											<div class="input-group-prepend">
											<span class="input-group-text"><?php echo e(Hyvikk::get('currency')); ?></span></div>
											<?php echo Form::number('name['.$type.'_night_base_fare]',Hyvikk::fare($type.'_night_base_fare'),['class'=>"form-control",'required','min'=>0,'step'=>'0.01']); ?>
									...
									<div class="form-group col-md-3">
										...
										<div class="input-group mb-3">
											...
											<?php echo Form::number('name['.$type.'_night_wait_time]',Hyvikk::fare($type.'_night_wait_time'),['class'=>"form-control",'required','min'=>0,'step'=>'0.01']); ?>
									...
									<div class="form-group col-md-3">
										...
										<div class="input-group mb-3">
											<div class="input-group-prepend">
											<span class="input-group-text"><?php echo e(Hyvikk::get('currency')); ?></span></div>
											<?php echo Form::number('name['.$type.'_night_std_fare]',Hyvikk::fare($type.'_night_std_fare'),['class'=>"form-control",'required','min'=>0,'step'=>'0.01']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fleet-manager-6(noedit)\framework\resources\views/utilities/fare_settings.blade.php ENDPATH**/ ?>