...
<li class="breadcrumb-item active"><?php echo app('translator')->get('fleet.add_quote'); ?></li>
<?php $__env->stopSection(); ?>
  ...
  <div class="col-md-12">
    <div class="card card-success">
      <div class="card-header">
        <h3 class="card-title">
          <?php echo app('translator')->get('fleet.add_quote'); ?>
        </h3>
      </div>
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              ...
              <?php if(Auth::user()->user_type != "C"): ?> <a href="#" data-toggle="modal" data-target="#exampleModal"><?php echo app('translator')->get('fleet.new_customer'); ?></a> <?php endif; ?>
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <div class="input-group mb-3">
                ...
                <?php echo Form::number('total_tax_percent',$tax_percent,['class'=>'form-control sum','readonly','id'=>'total_tax_charge','min'=>0,'step'=>'0.01']); ?>
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fleet-manager-6(noedit)\framework\resources\views/booking_quotation/create.blade.php ENDPATH**/ ?>