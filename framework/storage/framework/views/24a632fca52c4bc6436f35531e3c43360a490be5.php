...
<div class="wrapper">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="<?php echo e(url('admin/reminder',['type'=>'service-reminder'])); ?>" class="dropdown-item">
            <i class="fa fa-clock-o mr-2"></i> <?php echo app('translator')->get('fleet.serviceReminders'); ?>
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="#" class="dropdown-item">
            ...
            <div style="margin: 5px;">
              <a href="<?php echo e(url('admin/change-details/'.Auth::user()->id)); ?>" class="btn btn-secondary btn-flat"><i class="fa fa-edit"></i> <?php echo app('translator')->get('fleet.editProfile'); ?></a>
    ...
    <div class="sidebar">
     ...
     <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo e(url('admin/vehicle-inspection')); ?>" class="nav-link <?php if((Request::is('admin/vehicle-inspection*')) || (Request::is('admin/view-vehicle-inspection*')) || (Request::is('admin/print-vehicle-inspection*'))): ?> active <?php endif; ?>">
        ...
        <?php if(!Auth::guest() &&  Auth::user()->user_type != "D" && Auth::user()->user_type != "C" ): ?>
          ...
          <?php endif; ?> 
            ...
            <?php if((Request::is('admin/driver-logs')) || (Request::is('admin/vehicle-types*')) || (Request::is('admin/vehicles*')) || (Request::is('admin/vehicle_group*')) || (Request::is('admin/vehicle-reviews*')) || (Request::is('admin/view-vehicle-review*')) || (Request::is('admin/vehicle-review*')) || (Request::is('admin/vehicle-make*')) || (Request::is('admin/vehicle-model*')) || (Request::is('admin/vehicle-color*'))): ?>
            <?php ($class="menu-open"); ?>
            <?php ($active="active"); ?>
            ...
            <?php ($active=""); ?>
            <?php endif; ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['Vehicles list','VehicleType list','VehicleGroup list','VehicleInspection list','VehicleColors list','VehicleModels list','VehicleMaker list'])): ?>
           <li class="nav-item has-treeview <?php echo e($class); ?>">
            <a href="#" class="nav-link <?php echo e($active); ?>">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Vehicles list')): ?>
              ...
              <li class="nav-item">
                <a href="<?php echo e(route('vehicle-make.index')); ?>" class="nav-link <?php if(Request::is('admin/vehicle-make*')): ?> active <?php endif; ?>">
              ...
              <li class="nav-item">
                <a href="<?php echo e(route('vehicle-model.index')); ?>" class="nav-link <?php if(Request::is('admin/vehicle-model*')): ?> active <?php endif; ?>">
                  <i class="fa fa-car nav-icon"></i>
              ...
              <li class="nav-item">
                <a href="<?php echo e(route('vehicle-color.index')); ?>" class="nav-link <?php if(Request::is('admin/vehicle-color*')): ?> active <?php endif; ?>">
                  <i class="fa fa-car nav-icon"></i>
          ...
          <li class="nav-item has-treeview <?php echo e($class); ?>">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Bookings list')): ?>
              ...
              <li class="nav-item">
                <a href="<?php echo e(url('admin/transactions')); ?>" class="nav-link <?php if((Request::is('admin/transactions'))): ?> active <?php endif; ?>">
          ...
          <li class="nav-item has-treeview <?php echo e($class); ?>">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo e(route('reports.work_order')); ?>" class="nav-link <?php if(Request::is('admin/reports/work-order')): ?> active <?php endif; ?>">
                  <i class="nav-icon fa fa-book"></i>
         ...
         <li class="nav-item has-treeview <?php echo e($class); ?>">
           ...
           <li class="nav-item has-treeview <?php echo e($class); ?>">
            ...
            <?php if(Request::is('admin/work_order*') || Request::is('admin/parts-used*') || Request::is('admin/mechanic*')): ?>
            <?php ($class="menu-open"); ?>
            <?php ($active="active"); ?>
          ...
          <li class="nav-item has-treeview <?php echo e($class); ?>">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Mechanics list')): ?>
              <li class="nav-item">
                <a href="<?php echo e(url('admin/mechanic')); ?>" class="nav-link <?php if(Request::is('admin/mechanic*')): ?> active <?php endif; ?>">
                  <i class="fa fa-user nav-icon"></i>
         ...
         <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Settings list')): ?>
          <li class="nav-item has-treeview <?php echo e($class); ?>">
            ...
            <ul class="nav nav-treeview">
              ...
              <?php if(Auth::user()->user_type == "S"): ?> 
              <li class="nav-item">
                <a href="<?php echo e(url('admin/payment-settings')); ?>" class="nav-link <?php if(Request::is('admin/payment-settings')): ?> active <?php endif; ?>">
                  <i class="fa fa-gear nav-icon"></i>
              ...
              <?php endif; ?>
              <li class="nav-item">
                <a href="<?php echo e(url('admin/twilio-settings')); ?>" class="nav-link <?php if(Request::is('admin/twilio-settings')): ?> active <?php endif; ?>">
                  <i class="fa fa-gear nav-icon"></i>
          ...
          <?php if(Hyvikk::api('api_key') != null && Hyvikk::api('db_url') != null): ?> <li class="nav-item">
          ...
          <?php if(Hyvikk::api('api') && Hyvikk::api('driver_review') == 1): ?> <li class="nav-item">
  ...
  <footer class="main-footer">
    ...
    <strong><?php echo Hyvikk::get('web_footer'); ?></strong>
    </div>
    <div class="float-right d-none d-sm-inline-block">
      <b><?php echo app('translator')->get('fleet.version'); ?></b> 6.0.0
    </div>
  </footer>
...
</html><?php /**PATH C:\xampp\htdocs\fleet-manager-6(noedit)\framework\resources\views/layouts/app.blade.php ENDPATH**/ ?>