...
<li class="breadcrumb-item active"><?php echo app('translator')->get('fleet.edit_service_item'); ?></li>
<?php $__env->stopSection(); ?>
  ...
  <div class="col-md-12">
    ...
    <div class="card card-warning">
      <div class="card-header">
        <h3 class="card-title">
          <?php echo app('translator')->get('fleet.edit_service_item'); ?>
        </h3>
      </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="card card-default">
              <div class="card-header">
                <h3 class="card-title">
                "<?php echo app('translator')->get('fleet.overdue'); ?>" <?php echo app('translator')->get('fleet.reminder_settings'); ?> <?php echo e($service->overdue_unit); ?>
          ...
          <div class="col-md-6">
            <div class="card card-default">
              <div class="card-header">
                <h3 class="card-title">
                "<?php echo app('translator')->get('fleet.due_soon'); ?>" <?php echo app('translator')->get('fleet.reminder_settings'); ?> <?php echo e($service->duesoon_unit); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make("layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fleet-manager-6(noedit)\framework\resources\views/service_items/edit.blade.php ENDPATH**/ ?>