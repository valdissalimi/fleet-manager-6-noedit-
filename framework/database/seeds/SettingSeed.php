...
class SettingSeed extends Seeder
{
    ...
    private function default_settings()
    {
        ...
        Settings::create(['label' => 'Website Footer', 'name' => 'web_footer', 'value' => '<p><span style="font-size: 16px;">© Hyvikk Solutions 2021. All Rights Reserved.&nbsp;<span class="vertical-spacer d-none d-lg-inline">|</span>&nbsp;Powered By&nbsp;</span><a href="https://hyvikk.com/" target="_blank" class="link"><span style="font-size: 16px;">Hyvikk</span></a></p>']);
